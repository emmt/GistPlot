...
/* need to create PL_S, PL_E, PL_W, PL_ROTATE, PL_DEATH, PL_HAND cursors
 * -- may as well do PL_N as well for consistent look
 *
 * notes:
...
_pl_w_cursor(int cursor)
{
  ...
  if (i>=0 && i<7) {
    ...
    c = CreateCursor(_pl_w_app_instance, cs->xhot, cs->yhot, w, h,
                    and_msk, xor_msk);
    w_cursbits = 0;
