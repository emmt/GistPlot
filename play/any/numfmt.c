...
extern int pl_num_formats(void);
...
main(int argc, char *argv[])
{
  ...
  fprintf(f,"#define PL_CHAR_ALIGN %d\n\n", type_alignment[0]);

  fprintf(f,"#define PL_SHORT_SIZE %dL\n", type_size[1]);
  fprintf(f,"#define PL_SHORT_ALIGN %d\n", type_alignment[1]);
  fprintf(f,"#define PL_SHORT_ORDER %d\n\n", type_order[1]);

  fprintf(f,"#define PL_INT_SIZE %dL\n", type_size[2]);
  fprintf(f,"#define PL_INT_ALIGN %d\n", type_alignment[2]);
  fprintf(f,"#define PL_INT_ORDER %d\n\n", type_order[2]);

  fprintf(f,"#define PL_LONG_SIZE %dL\n", type_size[3]);
  fprintf(f,"#define PL_LONG_ALIGN %d\n", type_alignment[3]);
  fprintf(f,"#define PL_LONG_ORDER %d\n\n", type_order[3]);

  fprintf(f,"#define PL_FLOAT_SIZE %dL\n", type_size[4]);
  fprintf(f,"#define PL_FLOAT_ALIGN %d\n", type_alignment[4]);
  fprintf(f,"#define PL_FLOAT_ORDER %d\n", type_order[4]);
  fprintf(f,"#define PL_FLOAT_LAYOUT %d, %d, %d, %d, %d, %d, %ldL\n\n",
  ...
  fprintf(f,"#define PL_DOUBLE_SIZE %dL\n", type_size[5]);
  fprintf(f,"#define PL_DOUBLE_ALIGN %d\n", type_alignment[5]);
  fprintf(f,"#define PL_DOUBLE_ORDER %d\n", type_order[5]);
  fprintf(f,"#define PL_DOUBLE_LAYOUT %d, %d, %d, %d, %d, %d, %ldL\n\n",
  ...
  fprintf(f,"#define PL_POINTER_SIZE %dL\n", type_size[6]);
  fprintf(f,"#define PL_POINTER_ALIGN %d\n\n", type_alignment[6]);

  fprintf(f,"#define PL_STRUCT_ALIGN %d\n", type_alignment[7]);
