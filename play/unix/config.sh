...
commonargs="-DCONFIG_SCRIPT $CFLAGS -I. -I.. -I../.. $LDFLAGS -o cfg config.c"
...
cargs="-DTEST_TIOCGPGRP -DCONFIG_SCRIPT $CFLAGS -I. -I.. -I../.. $LDFLAGS -c config.c"
...
#----------------------------------------------------------------------
args="-DCONFIG_SCRIPT $CFLAGS -I. -I.. -I../.. $LDFLAGS -o fputest fputest.c"
fpedef=
fpelib=
fpelibm=
